...
public enum ModArmorMaterials implements ArmorMaterial {
    PALE_ORE("pale_ore", 42, new int[]{5, 8, 10, 4}, 24, SoundEvents.ARMOR_EQUIP_NETHERITE, 5.0F, 0.5F, () -> {
        return Ingredient.of(ModItems.REFINED_PALE_ORE.get());
    });
    ...
    public String getName() {
        return PaleNest.MOD_ID + ":" + this.name;
    }
